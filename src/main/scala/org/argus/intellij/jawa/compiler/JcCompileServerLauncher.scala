...
import org.argus.intellij.jawa.compiler.JcCompileServerLauncher.ConfigureLinkListener
import org.jetbrains.jps.incremental.BuilderService
import org.argus.intellij.jawa.compiler.JcCompileServerLauncher._
import org.argus.intellij.jawa.extensions._
...
class JcCompileServerLauncher  extends ApplicationComponent {
  ...
  private def start(project: Project, jdk: JDK): Either[String, Process] = {
    import org.argus.intellij.jawa.compiler.JcCompileServerLauncher.{compilerJars, jvmParameters}
    ...
    compilerJars.partition(_.exists) match {
      case (presentFiles, Seq()) =>
        ...
        val ngRunnerFqn = "org.argus.intellij.jawa.nailgun.NailgunRunner"

...
import org.argus.intellij.jawa.lang.psi.impl.JawaParamImpl
import org.argus.intellij.jawa.lang.psi.stubs.{JawaParamStub, JawaStubElementTypes}
import org.argus.intellij.jawa.lang.psi.stubs.impl.JawaParamStubImpl
...
class JawaParamElementType(debugName: String) extends JawaStubElementType[JawaParamStub, JawaParam](debugName) {
  ...
  def createPsi(stub: JawaParamStub): JawaParam = {
    new JawaParamImpl(stub, JawaStubElementTypes.PARAM)
  }

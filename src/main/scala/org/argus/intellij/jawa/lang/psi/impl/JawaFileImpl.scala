...
import org.argus.intellij.jawa.decompiler.{CompiledFileAdjuster, DecompilerUtil}
...
object JawaFileImpl {
  private val LOG: Logger = Logger.getInstance("#org.argus.intellij.jawa.lang.psi.impl.JawaFileImpl")

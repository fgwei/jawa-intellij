...
public abstract class JawaReferenceExpressionPsiElement extends JawaExpressionPsiElement implements JawaReferenceExpression {
    ...
    private static final Logger LOG = Logger.getInstance("#org.argus.intellij.jawa.lang.psi.JawaReferenceExpressionPsiElement");
    ...
    public void processVariants(@NotNull PsiScopeProcessor processor) {
        ...
        if(this.isQualified()) {
            filter = new OrFilter(
                    ...
                    new AndFilter(ElementClassFilter.METHOD, new NotFilter(new ConstructorFilter())),
                    ElementClassFilter.VARIABLE);
        } else {
            filter = new OrFilter(
                    ElementClassFilter.CLASS,
                    new AndFilter(ElementClassFilter.METHOD, new NotFilter(new ConstructorFilter())),

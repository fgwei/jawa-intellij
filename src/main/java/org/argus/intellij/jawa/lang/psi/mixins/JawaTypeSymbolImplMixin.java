...
import org.argus.intellij.jawa.lang.psi.JawaStubBasedPsiElementBase;
...
public abstract class JawaTypeSymbolImplMixin
    ...
    private static final Logger LOG = Logger.getInstance("#org.argus.intellij.jawa.lang.psi.mixins.JawaTypeSymbolImplMixin");
    ...
    public void processVariants(@NotNull PsiScopeProcessor processor) {
        OrFilter filter;
        if(isQualified()) {
            filter = new OrFilter(ElementClassFilter.PACKAGE, ElementClassFilter.CLASS);
        } else {
            filter = new OrFilter(ElementClassFilter.PACKAGE);
        }
